...
$(function () {
  ...
  sliderdnow.on("click", function (e) {
    ...
    let xc = $(this)
      .parent()
      .siblings(".original-form")
      .children(".input-denoate")
      .val();
  ...
  oprojecstnow.on("click", function (e) {
    // e.preventDefault();
    let ourprojectvalue = $(this)
      .parent()
      .siblings(".ourprojectnowvalue")
      .val();
  ...
  pvalue.on("keyup", function () {
    ...
    if ($(this).val() != "") {
      if (!isNaN($(this).val())) check.css("display", "inline-block");
  ...
  projectdetail.on("click", function (e) {
    let projectdetailvalue = $(this)
      .parent()
      .siblings()
      .find(".detailForm")
      .children(".projectdetailvalue")
      .val();
  ...
  customProjectdetail.on("click", function (e) {
    let customprojectdetailvalue = $(this)
      .parent()
      .siblings()
      .find(".customDetailForm")
      .children(".customprojectdetailvalue")
      .val();
...
$(document).ready(function () {
  ...
  switch (_cart_form.length) {
    case 0:
      $(".cart .content").addClass("fix_0");
      break;
    case 1:
      $(".cart .content").addClass("fix_1");
      break;
    case 2:
      $(".cart .content").addClass("fix_2");
      break;
    case 3:
      $(".cart .content").addClass("fix_3");
      break;
    case 4:
      $(".cart .content").addClass("fix_4");
      break;
  ...
  _add_.on("click", function (e) {
    ...
    if ($(this).siblings(".c_c").val() === "") {
      console.error("input can't be empty ");
      e.preventDefault();
    } else if ($(this).siblings(".c_c").val() < 1) {
      console.error("input must be grater than or equal to 1 ");
      e.preventDefault();
